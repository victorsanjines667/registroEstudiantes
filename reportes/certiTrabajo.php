...
if(isset($idCertificado)){
	...
	$fechaFin = $resultado->getFechaFin();
	...
	$idFuncionario = $resultado2->getIdFuncionario();
		...
		$fecha_fin_f = explode('-',$fechaFin);
		$fecha_fin_str = $fecha_fin_f[2] . " de " . $pdf->name_date($fecha_fin_f[1]). " de " . $fecha_fin_f[0];
 		//$pdf->xheader = 40;
        //$pdf->yheader = 8;
